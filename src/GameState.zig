...
pub const Entity = @import("world/entity/Entity.zig");
pub const Item = @import("world/item/Item.zig");
...
pub const PlayerCombat = @import("world/entity/PlayerCombat.zig").PlayerCombat;
const WorldStreamingMod = @import("world/WorldStreaming.zig");
pub const WorldStreamingState = WorldStreamingMod.WorldStreamingState;
const PlayerInventoryMod = @import("world/entity/PlayerInventory.zig");
pub const PlayerInventory = PlayerInventoryMod.PlayerInventory;
pub const BlockRegistry = @import("world/BlockRegistry.zig");
