...
pub const VK_IMAGE_VIEW_TYPE_2D_ARRAY = c.VK_IMAGE_VIEW_TYPE_2D_ARRAY;
...
pub const VK_PIPELINE_STAGE_HOST_BIT = c.VK_PIPELINE_STAGE_HOST_BIT;
...
pub const VK_BLEND_FACTOR_ONE_MINUS_DST_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_DST_COLOR;
pub const VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR;
