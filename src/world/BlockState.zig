...
fn computeProps(block: Block, props: u8) StateProps {
    ...
    return .{
        ...
        .emitted_light = switch (block) {
            ...
            .red_glowstone => .{ 255, 50, 30 },
            .crimson_glowstone => .{ 180, 20, 40 },
            .orange_glowstone => .{ 255, 150, 30 },
            .peach_glowstone => .{ 255, 180, 120 },
            .lime_glowstone => .{ 120, 255, 40 },
            .green_glowstone => .{ 40, 200, 60 },
            .teal_glowstone => .{ 30, 180, 150 },
            .cyan_glowstone => .{ 30, 220, 220 },
            .light_blue_glowstone => .{ 80, 160, 255 },
            .blue_glowstone => .{ 40, 80, 255 },
            .navy_glowstone => .{ 30, 40, 180 },
            .indigo_glowstone => .{ 100, 40, 220 },
            .purple_glowstone => .{ 160, 50, 255 },
            .magenta_glowstone => .{ 220, 50, 200 },
            .pink_glowstone => .{ 255, 110, 170 },
            .hot_pink_glowstone => .{ 255, 50, 120 },
            .white_glowstone => .{ 240, 240, 255 },
            .warm_white_glowstone => .{ 255, 220, 180 },
            .light_gray_glowstone => .{ 180, 180, 190 },
            .gray_glowstone => .{ 120, 120, 130 },
            .brown_glowstone => .{ 160, 100, 50 },
...
fn computeTexIndices(block: Block, props: u8) TexIndices {
    return switch (block) {
        ...
        .red_glowstone => .{ .top = 34, .side = 34 },
        .crimson_glowstone => .{ .top = 35, .side = 35 },
        .orange_glowstone => .{ .top = 36, .side = 36 },
        .peach_glowstone => .{ .top = 37, .side = 37 },
        .lime_glowstone => .{ .top = 38, .side = 38 },
        .green_glowstone => .{ .top = 39, .side = 39 },
        .teal_glowstone => .{ .top = 40, .side = 40 },
        .cyan_glowstone => .{ .top = 41, .side = 41 },
        .light_blue_glowstone => .{ .top = 42, .side = 42 },
        .blue_glowstone => .{ .top = 43, .side = 43 },
        .navy_glowstone => .{ .top = 44, .side = 44 },
        .indigo_glowstone => .{ .top = 45, .side = 45 },
        .purple_glowstone => .{ .top = 46, .side = 46 },
        .magenta_glowstone => .{ .top = 47, .side = 47 },
        .pink_glowstone => .{ .top = 48, .side = 48 },
        .hot_pink_glowstone => .{ .top = 49, .side = 49 },
        .white_glowstone => .{ .top = 50, .side = 50 },
        .warm_white_glowstone => .{ .top = 51, .side = 51 },
        .light_gray_glowstone => .{ .top = 52, .side = 52 },
        .gray_glowstone => .{ .top = 53, .side = 53 },
        .brown_glowstone => .{ .top = 54, .side = 54 },
        .tan_glowstone => .{ .top = 55, .side = 55 },
        .black_glowstone => .{ .top = 56, .side = 56 },
        .sand => .{ .top = 5, .side = 5 },
        .snow => .{ .top = 6, .side = 6 },
        .water => .{ .top = 7, .side = 7 },
        .gravel => .{ .top = 8, .side = 8 },
