...
pub const UiRenderer = struct {
    ...
    pub fn init(
        ...
        var self = UiRenderer{
            ...
            .vertex_allocs = .{ BufferAllocation.EMPTY, BufferAllocation.EMPTY },
            .gpu_alloc = gpu_alloc,
            .current_frame = 0,
            .vertex_count = 0,
            .screen_width = 800.0,
    ...
    pub fn loadHudAtlas(self: *UiRenderer, allocator: std.mem.Allocator, ctx: *const VulkanContext) !void {
        ...
        vk.cmdPipelineBarrier(cmd, vk.VK_PIPELINE_STAGE_HOST_BIT, vk.VK_PIPELINE_STAGE_TRANSFER_BIT, 0, 0, null, 0, null, 1, &[_]vk.VkImageMemoryBarrier{to_transfer});
