...
pub const VulkanRenderer = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, window: *const Window, game_state: ?*GameState) !*VulkanRenderer {
        ...
        const ctx = VulkanContext{
            ...
            .command_pool = std.mem.zeroes(vk.VkCommandPool),
        ...
        self.* = .{
            ...
            .deferred_face_frees = std.mem.zeroes([MAX_FRAMES_IN_FLIGHT][2048]TlsfAllocator.Handle),
            .deferred_face_free_counts = .{0} ** MAX_FRAMES_IN_FLIGHT,
            .deferred_light_frees = std.mem.zeroes([MAX_FRAMES_IN_FLIGHT][2048]TlsfAllocator.Handle),
